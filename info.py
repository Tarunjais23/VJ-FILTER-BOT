...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002009145832')').split()]
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/tjdiscussion77') # Support Chat Link Without https:// or @

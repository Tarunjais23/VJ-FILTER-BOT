...
auth_channel = environ.get('AUTH_CHANNEL', '-1001955474435') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
reqst_channel = environ.get('REQST_CHANNEL_ID', '')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL',24963403))
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/tjmovies07')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/tjmovies077')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_To_Open_Linkl')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT','t.me/tjdiscussion77') # Support Chat Link Without https:// or @
